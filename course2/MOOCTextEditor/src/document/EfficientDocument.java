...
//		System.out.println("text: " + getText());
		boolean checkLastToken = false;
		
		for (String token : tokens) {
//			System.out.println("token: " + token + "| isWord(token): " + isWord(token) + "|tokens.indexOf(token): " + tokens.indexOf(token));
	...
	public static void main(String[] args) {
		testCase(
		 ...
		 testCase(new EfficientDocument("many??? Senteeeeeeeeeences are"), 6,
		 3, 2);
		testCase(
