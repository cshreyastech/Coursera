...
//			System.out.println("s: " + s);
			...
			List<String> oneStepAway = new ArrayList<String>();
			oneStepAway = distanceOne(s, true);
			
			
			for(int index = 0; index < oneStepAway.size(); index++) {
				word = oneStepAway.get(index);
//				System.out.print( word + ", ");
				...
				if(!retList.contains(word) && retList.size() < numSuggestions) {
					retList.add(word);
				}
			}
